...
!(function (e, t) {
				...
				updateSlides: function () {
					...
					if (void 0 !== r) {
						...
						if (
							...
							s.css(
								(((z = {})[t('width')] = e.virtualSize + i.spaceBetween + 'px'), z)
							);
						if (i.slidesPerColumn > 1)
							if (
								...
								s.css(
									(((P = {})[t('width')] = e.virtualSize + i.spaceBetween + 'px'),
									P)
								),
								i.centeredSlides)
							) {
				...
				translateTo: function (e, t, a, i, s) {
					...
					if (
						...
						if (0 === t) o[u ? 'scrollLeft' : 'scrollTop'] = -l;
							...
							o.scrollTo(
								(((c = {})[u ? 'left' : 'top'] = -l), (c.behavior = 'smooth'), c)
							);
	...
	var _ = {
			update: function (e) {
				...
				if (
					(C(t.virtual, { from: y, to: E, offset: x, slidesGrid: t.slidesGrid }),
					p === y && c === E && !e)
				)
					return (
				...
				for (var P = 0; P < u.length; P += 1)
					P >= y &&
						P <= E &&
						(void 0 === c || e ? M.push(P) : (P > c && M.push(P), P < p && S.push(P)));
	...
	var K = {
			...
			handle: function (e) {
				...
				if (
					...
					(!!a.params.loop || !(l === a.minTranslate() || l === a.maxTranslate())) &&
						a.params.nested &&
						t.stopPropagation(),
					a.params.freeMode)
				) {
					...
					if (!c) {
						...
						if (
							...
							var g = f.length ? f[f.length - 1] : void 0,
								b = f[0];
							if (
								(f.push(d), g && (d.delta > g.delta || d.direction !== g.direction))
							)
								f.splice(0);
							else if (
								f.length >= 15 &&
			...
			setTranslate: function () {
				...
				for (var v = 0; v < s.length; v += 1) {
					...
					var S =
						...
						'px)';
					if (
						(y <= 1 && y > -1 && ((h = 90 * g + 90 * y), o && (h = 90 * -g - 90 * y)),
						f.transform(S),
						p.slideShadows)
					) {
						var C = c
			...
			setTranslate: function () {
				for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
					...
					var n = -180 * r,
						...
						d = 0;
					if (
						(e.isHorizontal() ? a && (n = -n) : ((d = l), (l = 0), (o = -n), (n = 0)),
			...
			onThumbClick: function () {
				...
				if (t) {
					var a = t.clickedIndex,
						i = t.clickedSlide;
					if (
						!((i && m(i).hasClass(e.params.thumbs.slideThumbActiveClass)) || null == a)
					) {
						var s;
						if (
							((s = t.params.loop
		...
		he = [
			...
			},
			{
				...
				create: function () {
					M(this, {
						scrollbar: t({ isTouched: !1, timeout: null, dragTimeout: null }, Q),
					});
				},
				on: {
					init: function (e) {
